...
export const initializeSellerGoogleStrategy = () => {
...
export const googleSellerCallbackHandler = async (req, res) => {
    try {
        const accessToken = jwt.sign(
            { id: req.user._id, role: 'seller' },
...
export const googleSellerLogoutHandler = (req, res) => {
    try {
        req.logout((err) => {
            if (err) {
